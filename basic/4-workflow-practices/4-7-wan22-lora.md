...
## ComfyUI 공식 Wan 2.2 워크플로우 참조

아래는 ComfyUI 공식 예제 사이트의 Wan 2.2 워크플로우입니다. 이 워크플로우를 기반으로 LoRA를 추가하여 실습합니다.

**Text-to-Video 워크플로우 (5B 모델):**

![ComfyUI 공식 Wan 2.2 5B Text-to-Video 워크플로우](../../.gitbook/assets/text_to_video_wan22_5B.webp)

**Image-to-Video 워크플로우 (5B 모델):**

![ComfyUI 공식 Wan 2.2 5B Image-to-Video 워크플로우](../../.gitbook/assets/image_to_video_wan22_5B.webp)
...
Lightning LoRA는 빠른 프로토타이핑에 적합합니다. 여러 아이디어를 빠르게 테스트한 후 최종 결과물은 일반 모델로 생성하는 전략도 유용하지만, 대부분의 경우 Lightning LoRA의 품질도 충분합니다.
