...
아래는 ComfyUI 공식 예제의 5B T2V 워크플로우입니다. 이 이미지를 ComfyUI에 드래그하면 워크플로우를 바로 불러올 수 있습니다.
...
아래는 ComfyUI 공식 예제의 14B T2V 워크플로우입니다.

![ComfyUI 공식 Wan 2.2 14B Text-to-Video 워크플로우](../../.gitbook/assets/text_to_video_wan22_14B.webp)
...
아래는 ComfyUI 공식 예제의 14B I2V 워크플로우입니다.

![ComfyUI 공식 Wan 2.2 14B Image-to-Video 워크플로우](../../.gitbook/assets/image_to_video_wan22_14B.webp)
...
> 비디오 생성은 시간이 오래 걸립니다. 처음에는 낮은 해상도(512x288)와 적은 프레임 수(예: 49프레임)로 테스트하여 프롬프트와 설정을 실험한 후, 만족스러운 결과가 나오면 해상도와 프레임을 올려서 최종 버전을 생성하세요.
