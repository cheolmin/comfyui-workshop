...
아래는 ComfyUI 공식 예제 사이트의 Qwen Image 워크플로우입니다. 이 이미지를 ComfyUI에 드래그하면 워크플로우를 바로 불러올 수 있습니다.

**기본 Text-to-Image 워크플로우:**

![ComfyUI 공식 Qwen Image 기본 워크플로우](../../.gitbook/assets/qwen_image_basic_example.png)
