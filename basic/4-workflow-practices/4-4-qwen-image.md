# #4-4. Qwen Image Edit / Layered 실습
...
![Qwen Image Edit 워크플로우 개요](../images/qwen/qwen-image-guide.jpg)
*Qwen Image Edit 워크플로우 전체 구조*
...
![ControlNet 입력 타입](../images/qwen/controlnet-input-types.jpg)
*다양한 ControlNet 입력 타입 (Canny, Depth, Inpaint)*
...
| 모델 | 저장 경로 | 다운로드 링크 |
|------|-----------|---------------|
| qwen_image_edit_2511_bf16.safetensors | ComfyUI/models/diffusion_models/ | [Hugging Face](https://huggingface.co/Comfy-Org/qwen_image_edit_2511) |
| qwen_2.5_vl_7b_fp8_scaled.safetensors | ComfyUI/models/text_encoders/ | [Hugging Face](https://huggingface.co/Comfy-Org/qwen_2.5_vl_7b) |
| qwen_image_vae.safetensors | ComfyUI/models/vae/ | [Hugging Face](https://huggingface.co/Comfy-Org/qwen_image_vae) |
...
![GGUF 모델 버전 워크플로우](../images/qwen/qwen-image-gguf.jpg)
*GGUF 버전 모델 로드 워크플로우*
...
![Inpaint 워크플로우](../images/qwen/inpaint-workflow.jpg)
*Inpaint 방식의 영역 편집 워크플로우*
...
![Canny ControlNet 워크플로우](../images/qwen/canny-workflow.jpg)
*Canny ControlNet을 활용한 편집 워크플로우 예시*
...
![Qwen Image Layered 레이어 분해 예시](../images/qwen/layered-example.jpg)
*이미지를 여러 독립 레이어로 분해하는 예시*
...
| 모델 | 저장 경로 | 다운로드 링크 |
|------|-----------|---------------|
| qwen_image_layered_bf16.safetensors (또는 fp8) | ComfyUI/models/diffusion_models/ | [Hugging Face](https://huggingface.co/Comfy-Org/qwen_image_layered) |
| qwen_2.5_vl_7b_fp8_scaled.safetensors | ComfyUI/models/text_encoders/ | [Hugging Face](https://huggingface.co/Comfy-Org/qwen_2.5_vl_7b) |
| qwen_image_vae.safetensors | ComfyUI/models/vae/ | [Hugging Face](https://huggingface.co/Comfy-Org/qwen_image_vae) |
