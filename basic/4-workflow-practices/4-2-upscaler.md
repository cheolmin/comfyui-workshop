...
| ------------- | ----- | -- | ----- | -------- | --------------- |
| 1. 픽셀 리샘플링    | 매우 빠름 | 낮음 | 매우 낮음 | 불가       | 빠른 프리뷰, 크기만 키우기 |
| 2. SD 이차 샘플링  | 빠름    | 중간 | 중간    | 가능 (불안정) | 창의적 디테일 추가      |
| 3. CCSR/SUPIR | 느림    | 높음 | 높음    | 가능 (안정적) | 최종 결과물, 최고 품질   |
...
> 처음에는 Ultrasharp 4x로 시작하는 것을 권장합니다. 가장 빠르고 안정적이며 대부분의 경우 충분한 품질을 제공합니다. CCSR이나 SUPIR은 최종 결과물에만 사용하세요.
...
3. 검색창에 `ComfyUI-SUPIR` 입력 → **Install** 클릭
4. ComfyUI **재시작**
...
| juggernaut-xl  | `ComfyUI/models/checkpoints/` | [https://huggingface.co/AiWise/Juggernaut-XL-V9-GE-RDPhoto2-Lightning\_4S/tree/main](https://huggingface.co/AiWise/Juggernaut-XL-V9-GE-RDPhoto2-Lightning_4S/tree/main) |

> **참고**: SUPIR-v0Q는 품질(Quality) 중심, SUPIR-v0F는 충실도(Fidelity) 중심 모델입니다. 용도에 맞게 선택하세요.

### Step 3: 워크플로우 구성

{% file src="../../.gitbook/assets/supir_lightning_example_02.json" %}
...
<figure><img src="../../.gitbook/assets/esrgan_example.avif" alt=""><figcaption></figcaption></figure>
...
| 방식            | 속도    | 품질    | VRAM | 추천 상황      |
| ------------- | ----- | ----- | ---- | ---------- |
| Ultrasharp 4x | 매우 빠름 | 높음    | 낮음   | 빠른 업스케일    |
| CCSR          | 보통    | 매우 높음 | 중간   | 콘텐츠 일관성 유지 |
| SUPIR         | 느림    | 최고    | 높음   | 최고 품질 필요 시 |
| CCSR + SUPIR  | 매우 느림 | 최고    | 높음   | 최종 결과물     |
