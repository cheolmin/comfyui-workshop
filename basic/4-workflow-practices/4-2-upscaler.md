...
![픽셀 리샘플링 확대 개요](../images/upscaler/upscale-overview.jpg)
...
![업스케일 워크플로우 입력 이미지 예시](../images/upscaler/upscale-input.png)
...
![SD 이차 샘플링 확대 워크플로우](../images/upscaler/upscale-sampling-workflow.jpg)

### 텍스트-이미지 생성 후 직접 확대 워크플로우

![텍스트-이미지 생성 후 직접 확대 워크플로우](../images/upscaler/upscale-txt2img-workflow.jpg)

### 확대 모델 사용 워크플로우

![확대 모델 사용 워크플로우](../images/upscaler/upscale-model-workflow.jpg)
