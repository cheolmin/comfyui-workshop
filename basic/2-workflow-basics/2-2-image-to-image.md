...
아래는 ComfyUI 공식 예제의 img2img 워크플로우입니다. 이 이미지를 ComfyUI에 드래그하면 워크플로우를 바로 불러올 수 있습니다.
...
```
       원본 이미지 영향 ◄──────────────────► 프롬프트 영향
denoise 0.3:  ████████████████░░░░  (원본 80% + 프롬프트 20%)
denoise 0.5:  ████████████░░░░░░░░  (원본 60% + 프롬프트 40%)
denoise 0.7:  ████████░░░░░░░░░░░░  (원본 40% + 프롬프트 60%)
denoise 0.8:  ██████░░░░░░░░░░░░░░  (원본 30% + 프롬프트 70%) 권장
denoise 0.9:  ████░░░░░░░░░░░░░░░░  (원본 20% + 프롬프트 80%)
denoise 1.0:  ░░░░░░░░░░░░░░░░░░░░  (원본 0% + 프롬프트 100%)
```
...
```
애니메이션 스타일, 지브리 풍, 생동감 있는 색감, 세밀한 배경, 화려한 도시 거리
```
...
**언제 사용?** 사진을 만화나 애니메이션 그림으로 바꾸고 싶을 때
...
```
밤 풍경, 별이 빛나는 하늘, 달빛, 짙은 파란 분위기, 도시 야경, 아름다운 밤 풍경
```
...
**언제 사용?** 낮 사진을 밤으로, 혹은 계절/시간대를 바꾸고 싶을 때
...
```
상세한 디지털 아트, 완전히 채색된 일러스트, 전문가 수준 작품, 완성된 렌더링, 생생한 색감
```
...
**언제 사용?** 러프 스케치나 밑그림을 완성된 작품으로 만들고 싶을 때
...
**ComfyUI Wiki - img2img:** [https://comfyui-wiki.com/en/workflows/img2img](https://comfyui-wiki.com/en/workflows/img2img)
