...
2. `sharp` 검색 → **Sharp** 설치.
   ...
   ![rgthree 설치](images/image52.png)

   ![Sharp 설치](images/image20.png)

3. 모델 다운로드:

| 모델 | 다운로드 링크 |
|---|---|
| qwen_image_edit_2511_bf16.safetensors | https://huggingface.co/Comfy-Org/Qwen-Image-Edit_ComfyUI |

   ![모델 다운로드](images/image18.png)

### 워크플로 실행

1. 제공된 `AWS_MZC_3DGS_Repair.json` 워크플로를 로딩합니다.

   ![워크플로](images/image11.png)

2. **Fast Group Muter**에서 `Enable 3D Gaussian Splatting Generation` 그룹만 활성화합니다.

   ![Group Muter](images/image65.png)

3. 생성하고 싶은 이미지를 로딩한 뒤 Queue를 눌러 **PLY 파일**을 생성합니다.

   ![PLY 생성](images/image31.png)
...
5. Fast Groups Muter에서 **3D Gaussian Splatting Generation**, **3DGS Repair**, **Preview & Save** 그룹을 모두 활성화합니다.
   ...
   ![그룹 활성화](images/image22.png)

6. Queue를 실행하여 이미지를 생성합니다.

   ![생성 결과 1](images/image59.png)

   ![생성 결과 2](images/image56.png)