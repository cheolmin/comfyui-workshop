## #1. Yedp Action Director

![Yedp Action Director](images/image55.png)
...
2. Missing Custom 노드를 설치합니다. ComfyUI Manager → **Install Missing Custom Nodes** 클릭.
   ...
   ![Missing Nodes](images/image12.png)

3. **ComfyUI-VideoHelperSuite**를 설치합니다.

   ![VideoHelperSuite](images/image7.png)

4. 정상적으로 로딩된 워크플로를 확인합니다. 로딩할 애니메이션은 `..\ComfyUI\input\yedp_anims` 폴더에 존재해야 합니다.

   ![워크플로 확인](images/image17.png)

   ![워크플로 노드](images/image6.png)
...
2. 원하는 애니메이션을 선택 후 **Download** 클릭 → 다운로드 세팅 확인 후 Download.
   ...
   ![Mixamo 다운로드](images/image19.png)

   ![다운로드 세팅](images/image28.png)
